...
{	
	...
	static void* (*FMemory_Realloc)(void* Memory, int32 Size, int32 Align) = decltype(FMemory_Realloc)(int64(GetModuleHandleW(0)) + 0x6E090E8);
	...
	public:
		inline void Copy(TArray<ArrayElementType>* Out)
		{
		...
		void Reserve(const int Num, size_t Size = sizeof(ArrayElementType))
		{
			Data = (ArrayElementType*)FMemory_Realloc(Data, (MaxElements = Num + NumElements) * Size, ElementAlign);
		}

		ArrayElementType& Add(const ArrayElementType& InData, size_t Size = sizeof(ArrayElementType))
		{
			//Reserve(1, Size);
		...
		inline void Clear()
		{
			...
			if (!Data)
				Data = (ArrayElementType*)FMemory_Realloc(0, NumElements * ElementSize, ElementAlign);
		}
